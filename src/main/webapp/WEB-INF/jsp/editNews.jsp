    ...
    <form action="${pageContext.request.contextPath}/new/update" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" tabindex="1" id="to" class="form-control"
                   value="${editResult.data.aNew.title}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="author " tabindex="1" id="dov" class="form-control"
                   value="${editResult.data.user.userName}">
        </div>
        <div class="form-group">
            <label for="do" class="">关键字:</label>
            <input type="text" name="keyWords" tabindex="1" id="do" class="form-control"
                   value="${editResult.data.aNew.keyWords}">
        </div>
