...
public class UserController {
    ...
    public String toregister(User user, Model model,HttpSession session) {
    ...
    public String toadminLogin(HttpSession session,String username, String password, Model model) {
    ...
    public String Logout(HttpSession session,String userName, Model model) {
